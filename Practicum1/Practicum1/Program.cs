...
namespace Alg1.Practica.Practicum1
{
    class MainClass
    {
        ...
        private static void week1_OrderedArray_Testaanroepen()
        {
            ...
            Console.WriteLine(orderedArray.Find(orderedArray.Array[2]));
            Console.WriteLine(orderedArray.Find(orderedArray.Array[5]));
            Console.WriteLine(orderedArray.Find(orderedArray.Array[8]));
